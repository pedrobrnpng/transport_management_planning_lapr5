...
init(NSV, NG, DP, P1, P2, P3, P4, P5):-
%init(NSV, NG1, DP1, P11, P21, P31, P41, P51):-
%	atom_number(NG1,NG),
%	atom_number(DP1,DP),
%	atom_number(P11,P1),
%	atom_number(P21,P2),
...
inicializa:-write('Serviço de Veículo: '),read(NSV), 
	(retract(vehicleduty(_));true), asserta(vehicleduty(NSV)),
...
gera_populacao(Pop):-
	...
	workblocks(NumWB),
	gera_populacao(TamPop,ListaMotoristas,NumWB,Pop).

gera_populacao(0,_,_,[]):-!.

gera_populacao(TamPop,ListaMotoristas,NumWB,[Ind|Resto]):-
	TamPop1 is TamPop-1,
	gera_populacao(TamPop1,ListaMotoristas,NumWB,Resto),
	gera_individuo(ListaMotoristas,NumWB,Ind),
	not(member(Ind,Resto)).
%o porque desta regra
gera_populacao(TamPop,ListaMotoristas,NumWB,L):-
	gera_populacao(TamPop,ListaMotoristas,NumWB,L).
