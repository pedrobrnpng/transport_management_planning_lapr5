...
{
    public class ServicoTripulanteServiceTests
    {
        ...
        public void Setup()
        {
            ...
            this._servicoTripulanteRepositoryMock.Setup(t => t.GetByDomainIdAsync("1")).Returns(Task.FromResult(this._servicoTripulante));
            this._servicoTripulanteRepositoryMock.Setup(t => t.GetByDomainIdAsync(It.Is<string>(x => !x.Equals("1")))).Returns(Task.FromResult(this._servicoTripulanteNull));
        ...
        {
            var result = this._servicoTripulanteService.AddAsync(this._criarServicoTripulanteDto);
            ...
            Assert.AreEqual(this._servicoTripulanteDto.nome, result.Result.nome);
            Assert.AreEqual(this._servicoTripulanteDto.tripulanteDomainId, result.Result.tripulanteDomainId);
            Assert.AreEqual(this._servicoTripulanteDto.cor, result.Result.cor);
            Assert.AreEqual(this._servicoTripulanteDto.blocosTrabalho[0], result.Result.blocosTrabalho[0]);
        }

        [Test]
        public void ShouldGetByDomainId()
        {
            var result = this._servicoTripulanteService.GetByDomainIdAsync("1");
